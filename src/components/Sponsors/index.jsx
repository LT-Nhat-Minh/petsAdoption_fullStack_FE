...
function Sponsors(props) {
  ...
  return (
    <div className="sponsors">
      <div>
        <h2>{isEnglish ? "OUR SPONSORS" : "NHÀ TÀI TRỢ CỐ ĐỊNH"}</h2>
        <span>
      ...
      <div>
        <div>
          ...
          <img src={img1} alt="" />
          <h3>{isEnglish ? "Me-O VietNam" : "Me-O Việt Nam"}</h3>
          <span>
            <img src={sticker} alt="" />
          </span>
        </div>
        <div>
          ...
          <img src={img2} alt="" />
          <h3>{isEnglish ? "SmartHeart VietNam" : "SmartHeart Việt Nam"}</h3>
          <span>
            <img src={sticker} alt="" />
          </span>
        </div>
        ...
        <div>
          <p>{isEnglish ? "IELTS Jim" : "IELTS Thầy Jim"}</p>
          <img src={img4} alt="" />
          <h3>{isEnglish ? "IELTS Jim" : "IELTS Thầy Jim"}</h3>
          <span>
            <img src={sticker} alt="" />
          </span>
        </div>
