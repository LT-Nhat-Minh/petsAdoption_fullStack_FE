...
const news = [
  ...
  },
  {
    ...
    des_english: "Reports last week showed that a pet dog in Hong Kong tested weakly positive for the coronavirus. The Pomeranian was considered a Covid-19 patient. The dog was subsequently tested again on February 29th to determine whether it was truly infected.",
    url: thumbnail5_2,
    category: ["5"],
  },
  {
    title: "Sở hữu lượt người theo dõi khủng trên MXH, 'mèo mắt lác' gây quỹ từ thiện gần 300 triệu chỉ nhờ bán hình ảnh của mình",
    title_english: "With Huge Social Media Following, 'Cross-eyed Cat' Raises Nearly 300 Million VND Just by Selling Its Photos",
    author: "Once More Life",
    date: "17/02/2020",
    ...
    des_english: "This Nebelung cat named Belarus suffers from strabismus, or crossed eyes, which gives it a very unique look. More importantly, Belarus' distinctive appearance has won the hearts of many cat lovers worldwide. The cat’s Instagram account has over 254,000 followers.",
    url: thumbnail5_3,
    category: ["5"],
  },
  {
  ...
  {
    title: "Cô mèo lém lỉnh mở hộp bánh rồi cắn mỗi cái một ít khiến chủ nhân 'cạn lời",
    title_english: "The mischievous cat opens a box of cookies and bites each one, leaving the owner speechless.",
    author: "Once More Life",
    date: "12/04/2020",
    ...
    des_english: "Since the mischievous cat named Nellie was adopted by her two owners, they discovered that she loves snacks, especially sweets. Nellie sniffs out food like a professional dog. Her love for food has helped her develop some tricks to find snacks.",
    url: thumbnail1_5,
    category: ["1"],
  },
  {
    title: "Cách li mùa dịch: Chú chó lạp xưởng thành shipper chuyên nghiệp lấy đồ ăn cho cô chủ",
    title_english: "Quarantine season: The Dachshund becomes a professional delivery dog for her owner.",
    author: "Once More Life",
    date: "12/04/2020",
    ...
    des_english: "For pet owners, dogs have become close companions during the current quarantine season. Recently, the image of a Dachshund joyfully carrying a McDonald's fast food bag through the streets has gone viral on social media.",
    url: thumbnail1_6,
    category: ["1"],
  },
  {
    title: "Chú chó trung thành đợi chủ suốt 11 năm bên cửa sổ, cho đến một ngày nó bỏ cuộc",
    title_english: "The loyal dog waited by the window for 11 years for its owner, until one day it gave up.",
    author: "Once More Life",
    date: "12/03/2020",
    ...
    des_english: "Eleven years ago, Roman's girlfriend brought a 2-year-old dog to their shared home in Chicago. The friendship between Roman and Toby (the dog) began with Toby pooping on the living room carpet.",
    url: thumbnail1_7,
    category: ["1"],
  },
  {
    title: "Nửa đêm, chú chó lạ tự bước vào sở cảnh sát để báo án về vụ mất tích của...chính mình",
    title_english: "At midnight, a strange dog walked into the police station to report... its own disappearance.",
    ...
    des_english: "Last week, the Odessa Police Department in Texas, USA, unexpectedly welcomed a strange guest at midnight. A friendly dog walked in and jumped up to the front desk. Its demeanor suggested it was there to report an accident or its own disappearance.",
    url: thumbnail1_8,
    category: ["1"],
  },
  {
  ...
  },
  {
    ...
    des_english: "The purring sound of cats is a sign of contentment. Cats usually purr when they feel happy or when they are eating. Recently, scientists have discovered the positive effects of this purring sound on human health. This is another reason why you might want to consider owning a cat in the future!",
    url: thumbnail3_2,
    category: ["3"],
  },
  {
  ...
  },
  {
    ...
    des_english: "Cats often have the quirky habit of being very mischievous, even waking you up during the night. There are some reasons for this behavior, as well as solutions to solve this seemingly troublesome issue!",
    url: thumbnail3_5,
    category: ["3"],
  },
  {
  ...
  },
  {
    ...
    des_english: "A woman found the bear abandoned at a garbage collection point. It was dirty, paralyzed in both hind legs, with atrophied muscles, and deformed bones. The bear had three injuries: a cut on its neck and two sores on its back. We took it in and provided treatment at veterinary clinics.",
    url: thumbnail6_2,
    category: ["6"],
  },
  {
    ...
    des_english: "Baby Cam was rescued on July 21, 2019, from a garbage dump. Its owner had allowed it to become so thin, resembling a skeleton, with paralyzed hind legs that prevented it from walking. It couldn’t escape as its legs were almost paralyzed, and ants swarmed its body. Without the timely rescue from the Hải Phòng Animal Rescue Station, Baby Cam wouldn't have survived the harsh weather conditions. The owner treated it as a mere decorative object and could discard it at any time when no longer useful.",
    url: thumbnail6_3,
    category: ["6"],
  },
  {
  ...
  },
  {
    ...
    des_english: "The transformation of Baby Sữa went from 3 kg to 5 kg, becoming more beautiful and adorable, full of energy and playful with friends.",
    url: thumbnail4_2,
    category: ["4"],
  },
  {
    ...
    des_english: "The difference when Smile was loved and cared for 😘, growing from 12 kg to 19 kg. Smile is a rescued dog from Hà Giang, and now, after being adopted, it's thriving.",
    url: thumbnail4_3,
    category: ["4"],
  },
  {
