...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaUniversity, FaPaypal } from "react-icons/fa";
import "./style.scss";
  ...
  return (
    <div className="container3">
      <div className="contact-info3">
        ...
        <p><FaEnvelope /> hanoipetadoption@gmail.com</p>
        <p><FaPhone /> (+84)39 320 1068</p>
        ...
        <div className="bank-info3">
          <div>
            <h3><FaUniversity /> Vietcombank</h3>
            <p>Phạm Thanh Hằng</p>
            <p>0011004054939</p>
            <p>Sở giao dịch Vietcombank</p>
          </div>
          <div>
            <h3><FaUniversity /> BIDV</h3>
            <p>Phạm Thanh Hằng</p>
            <p>12610000951797</p>
            <p>Chi Nhánh Ba Đình</p>
          </div>
          <div>
            <h3><FaUniversity /> Techcombank</h3>
            <p>Phạm Thanh Hằng</p>
            <p>19031456730888</p>
            <p>Chi Nhánh Hà Nội</p>
          </div>
          <div>
            <h3><FaPaypal /> Paypal</h3>
